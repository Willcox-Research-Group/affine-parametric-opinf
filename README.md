...
<!-- - [`ParametricHeat.ipynb`](./ParametricHeat.ipynb): notebook demonstrating classes from `heat.py`. -->
- [`plot_heat.py`](./plot_heat.py): script for heat equation results figures.
...
<!-- - [`ParametricFHN.ipynb`](./ParametricFHN.ipynb): notebook demonstrating classes from `fhn.py`. -->
- [`fhn_rom_search.py`](./fhn_rom_search.py): script for operator inference hyperparameter search.
- [`plot_fhn.py`](./plot_fhn.py): script for FitzHugh-Nagumo results figures.
...
- [`setup.cfg`](./setup.cfg): linting configuration.
- [`Makefile`: ](./Makefile`:)Use `make lint` to run the code linter.
